...
### [查看博客戳这里 👆](http://boysmao.github.io)
...
# Site settings
title: BOLG                    # 你的博客网站标题
SEOTitle: MXZ的博客 | MXZ BLOG		# SEO 标题
description: "Hey"	   	   # 随便说点，描述一下

# SNS settings      
github_username: xxxxx     # 你的github账号
jianshu_username: xxxxxxxx  # 你的简书ID。
...
在下面输入的社交账号，没有的添加的不会显示在侧边框中。新加入了[简书](https:/www.jianshu.com)
	# SNS settings
	RSS: false
